...
_REQUIRED_SRC = [
    "src/audiobook_ai/config.py", "src/audiobook_ai/cli.py",
    "src/audiobook_ai/models/normalizer.py", "src/audiobook_ai/models/baseline_rules.py",
    "src/audiobook_ai/models/expanders.py", "src/audiobook_ai/data/tn_corpus.py",
    "src/audiobook_ai/data/document.py", "src/audiobook_ai/training/train_normalizer.py",
    "src/audiobook_ai/training/evaluate.py", "src/audiobook_ai/synthesis/tts_backend.py",
    "src/audiobook_ai/synthesis/stitch.py", "src/audiobook_ai/agent/narrator_agent.py",
    "src/audiobook_ai/agent/policy.py", "src/audiobook_ai/api/main.py",
]
...
def build_checklist(repo_root) -> Dict:
    ...
    def check(name, ok, detail, optional=False):
        items.append({"name": name, "status": "PASS" if ok else ("WARN" if optional else "FAIL"),
                      "detail": detail})
    ...
    check("Agent: 4 decision points (policy.py)",
          (root / "src/audiobook_ai/agent/policy.py").is_file(), "D1-D4")

...
def get_config() -> AppConfig:
    path = os.environ.get("AUDIOBOOK_AI_INFER_CONFIG")
...
def get_agent():
    ...
    backend = os.environ.get("AUDIOBOOK_AI_TTS_BACKEND") or None
    return NarratorAgent(get_config(), load_model=True, tts_backend=backend)
